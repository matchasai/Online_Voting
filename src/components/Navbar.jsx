...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="fixed top-0 left-0 w-full h-screen bg-black/90 text-white flex flex-col items-center pt-24 transition-all duration-300">
          {/* Close Button */}
          <button
          ...
          <ul className="flex flex-col space-y-6 text-lg font-medium text-center">
            ...
            {/* Login Button (Now Positioned Properly) */}
            <li className="mt-4">
